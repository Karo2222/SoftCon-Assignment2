...
public class BonusCardTest {
    ...
    @Test
    public void getName() {
        BonusCard card_one = new BonusCard(200);
        assertEquals("Bonus200Card", card_one.getName());

        BonusCard card_two = new BonusCard(300);
        assertEquals("Bonus300Card", card_two.getName());

        BonusCard card_three = new BonusCard(400);
        assertEquals("Bonus400Card", card_three.getName());

        BonusCard card_four = new BonusCard(500);
        assertEquals("Bonus500Card", card_four.getName());

        BonusCard card_five = new BonusCard(600);
        assertEquals("Bonus600Card", card_five.getName());
    }
    ...
    public void executeTurnTest() {
        ...
        assertEquals(0, bonus.executeTurn("Test", diceSet));
